...
public class OrderMatchingEngine {
    ...
    public void processOrder(Order order, OrderBook orderBook) {
        ...
        if (matchedOrder.isPresent()) {
            ...
            kafkaOrderProducer.sendMessage(order.getInstrument() + " trading: " + " Order added to book: " + order, "orderbook");
        }
    }
    ...
    private void executeTrade(Order order1, Order order2, OrderBook orderBook) {
        ...
        kafkaOrderProducer.sendMessage(order1.getInstrument() + " trading: " + " Trade executed: " + tradeQuantity + " @ " + order1.getPrice(), "trades");
    }
}